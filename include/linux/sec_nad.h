...
enum {
    ...
    VST_BIG_UNZIPSPD_L7      = 5,
    VST_BIG_UNZIP_L11        = 6,
    VST_BIG_UNZIP_L16        = 7,
    
    VST_MIDD_UNZIP_L1_TO_17   = 8,
    VST_MIDD_C2_L1_TO_17      = 9,
    VST_MIDD_DIJ_L1_TO_17    = 10,
    VST_MIDD_FFT_L1_TO_17    = 11,
    VST_MIDD_UNZIP_L6        = 12,
    VST_MIDD_UNZIP_L10       = 13,
    
    VST_LITT_UNZIP_L2_TO_14  = 14,
    VST_LITT_C2_L2_TO_14     = 15,
    VST_LITT_DIJ_L2_TO_14    = 16,
    VST_LITT_FFT_L2_TO_14    = 17,
    VST_LITT_UNZIP_L4        = 18,
    VST_LITT_UNZIP_L6        = 19,
    
    VST_MIF_MEMTEST_ALL      = 20,
    VST_MIF_MEMTEST_L1       = 21,
    VST_MIF_MEMTEST_L3       = 22,   
    
    VST_INT_G2D_L0_TO_3      = 23,
    VST_INT_JPEG_L0_TO_3     = 24,
    VST_INT_MFC_L0_TO_3      = 25,   
    VST_INT_SSS_L0_TO_3      = 26, 
};
